...
public class TinyDB {
    ...
    public ArrayList<FlowValue> getListObject(String key){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<FlowValue> objects =  new ArrayList<FlowValue>();

    	for(String jObjString : objStrings){
            FlowValue value  = gson.fromJson(jObjString,  FlowValue.class);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public void putListObject(String key, ArrayList<FlowValue> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
